...
export const SUBJECT_CALCULATION_METHODS: CalculationMethodOption[] = [
  {
    id: 'custom_formula',
    title: 'معادلة مخصصة (بناء يدوي بالآلة الحاسبة)',
    formula: '(التقويم + فرض 1 + فرض 2 + الاختبار × 2) ÷ 5',
    badge: 'تخصيص حر 100%',
    description: 'بناء المعادلة الحسابية بحرية كاملة باستخدام مكونات العلامات (التقويم، الفروض، والاختبار) والعمليات الحسابية والأقواس.',
  },
  {
